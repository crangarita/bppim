    ...
    public function renderizar($vista, $item = false, $field = false, $h2 = '' )
    {
        ...
        if(Session::accesoView('admin')){
            $menu[] = array(
                'id' => 'proyecto',
                'titulo' => 'Proyectos',
                'ico' => '<i class="fa fa-database fa-fw"></i> ',
                'enlace' => BASE_URL.'proyecto/'
                );
            $menu[] = array(
                'id' => 'entidad',
                'titulo' => 'Entidades',
                'ico' => '<i class="fa fa-university fa-fw"></i> ',
                'enlace' => BASE_URL.'entidad/'
                );
            $menu[] = array(
                'id' => 'sector',
                'titulo' => 'Sectores',
                'ico' => '<i class="fa fa-sitemap fa-fw"></i> ',
                'enlace' => BASE_URL.'sector/'
                );
             $menu[] = array(
                'id' => 'funcionario',
                'titulo' => 'Funcionarios',
                'ico' => '<i class="fa fa-users fa-fw"></i> ',
                'enlace' => BASE_URL.'funcionario/'
                );
             $menu[] = array(
                'id' => 'informe',
                'titulo' => 'Informes',
