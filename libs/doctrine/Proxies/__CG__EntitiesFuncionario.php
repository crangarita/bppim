 ...
 */
class Funcionario extends \Entities\Funcionario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'cedula', 'nombre', 'cargo', 'estado', 'entidad');
        }
