...
{   
    ...
    public function get()
    {
        ...
        $datos['Descripcion'] = $obj->getNombre();
        $datos['Estado'] = $obj->getEstado()?'ACTIVO':'INACTIVO';
    ...
    private function obj($new = true)
    {
        ...
        $this->_model->getInstance()->setCedula($this->getTexto('cedula'));
        $this->_model->getInstance()->setNombre($this->getTexto('nombre'));
        $this->_model->getInstance()->setCargo($this->getTexto('cargo'));
        $this->_model->getInstance()->setEntidad($this->_entidad->get($this->getInt('entidad')));
